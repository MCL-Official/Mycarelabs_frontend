        ...
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    <h1 className="text-4xl text-orange-400 font-extrabold mx-auto md:text-5xl">
                    We Ensure Safe Testing
                    </h1>
                    <h3 className="text-2xl text-blue-800 font-extrabold mx-auto md:text-5xl">
                    How we Add Value
                    </h3>
                    <p className="max-w-xl text-left mx-auto xl:mx-0">
                    We simplify other organizations’ health initiatives as their single unified vendor for all disease, drug, and cancer testing. Outsourcing your testing to My Care Labs allows you to focus on your core business: K-12 or higher education student services; health care and patient health improvement; retail, office, manufacturing, or warehouse business; real estate property management; hotel and restaurant hospitality.                             </p>

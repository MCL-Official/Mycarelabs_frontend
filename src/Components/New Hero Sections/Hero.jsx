...
const Hero = () => {
  const slides = [
    ...
    },
    {
      ...
      subTitle: "Fast & Reliable COVID/RSV/FLU A&B Testing",
      desc:"Stay protected with same-day testing & quick results. Book now for peace of mind.",
      points: ["Comprehensive Drug & Alcohol Testing", "DOT & Non-DOT Testing Available", "Confidential & Fast Results"],
    ...
    },
    {
      ...
      points: ["Quick Detection for UTI Symptoms", "Lab-Tested for Accurate Results", "Discreet & Private Testing"],
      background:background4,
      heroRightImg:heroRightImg4
    },
    {
      title: "One Place for All Your Testing Needs",
      subTitle: "Fast, Reliable, and Affordable Testing Services",
      desc:"We provide accurate, same-day lab results at affordable prices. Whether you need routine screenings or specialized testing, we’ve got you covered.",
      points: ["COVID/RSV/FLU A&B Testing", "Wellness Testing", "Toxicology Testing","UTI Testing"],
    ...
    >
      {slides.map((slide, index) => (
        <SwiperSlide key={index}>
          <div className="relative bg-gray-50 pt-20 h-screen">
            {/* Background Image */}
            <div className="absolute inset-0 mt-[4rem]">
              <img
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              <div className="text-center text-black mb-12">
                <h1 className="text-4xl md:text-5xl font-bold leading-tight pt-[2rem]">
                  {slide.title}
                </h1>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-white relative">
                {/* Left Content */}
                <div className="text-center lg:text-left">
                  <div className="max-w-2xl mx-auto lg:mx-0">
                    <h2 className="my-2 text-left text-[#6291ff] text-xl md:text-2xl pl-8">
                      {slide.subTitle}
                    </h2>
                    <h3 className="my-2 text-left text-black text-lg md:text-2xl pl-8 font-thin">
                      {slide.desc}
                    </h3>
                    <h3 className="mt-4 mb-2 text-left text-[#ff6b1e] text-lg md:text-2xl pl-8 ">
                      What We Offer:
                    </h3>
                    <ul className="space-y-2">
                      {slide.points.map((point, i) => (
                        <li
                          key={i}
                          className="text-black font-thin text-xl text-left flex items-center"
                        >
                          <span className="bg-green-500 text-white rounded-full p-1 mr-2">
                            <TiTick size={16} />
                          </span>
                          {point}
                        </li>
                    ...
                    <h3 className="mt-4 mb-4 text-center text-black font-bold text-lg md:text-2xl pl-8 ">
                      Book your Appointment
                    </h3>
                    <div className="flex justify-center">
                      <button
                        onClick={handleClick}
                        className="px-4 py-2 text-2xl font-bold rounded-2xl bg-gradient-to-r from-[#f15a24] to-[#ff9450] no-underline text-white"
                      >
                        Book Now
                      </button>
                      <div className="flex justify-center mx-2 font-bold text-black text-xl items-center">
                        or
                      </div>
                      <a
            ...
            <img
              ...
              alt="Healthcare setup"
              className="lg:w-[40rem] h-auto absolute -bottom-[6px] right-0"
            />
          </div>
        </SwiperSlide>
      ))}

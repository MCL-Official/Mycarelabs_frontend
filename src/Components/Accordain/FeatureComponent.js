...
//       </Helmet>
//       <div className="flex justify-center items-center pt-2 min-h-screen bg-gradient-to-r from-blue-200 via-white to-blue-200">
...
//             </div>
//           ))}
//                       <div className="info-description text-black mt-4 sm:text-sm md:text-xl lg:text-xl pb-12 font-normal">
...
function FeatureComponent() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center pt-2 min-h-screen bg-gradient-to-r from-blue-200 via-white to-blue-200">       <div className="w-full lg:w-4/5  overflow-hidden ">
        <h3 className="flex justify-center text-2xl font-bold bg-transparent">          <div className="relative inline-block bg-transparent text-center mb-4">
          ...
          <div
            ...
            className="rounded-2xl border-2 p-6 bg-white flex flex-col lg:flex-row mt-6 h-auto lg:h-[40rem] transition-all shadow-[3px_3px_0px_black] hover:translate-x-[3px] hover:translate-y-[3px] ${selectedFeature === feature ? 'border-blue-600 text-blue-600' : 'border-gray-300'}"
          >
            <AnimatePresence custom={direction} mode="wait">
              <motion.img
                key={features[selectedFeature].image}

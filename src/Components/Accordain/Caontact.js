...
const Caontact = () => {
  return (
    <div id='contact-form'>
      {/* <div class="font-[sans-serif] max-w-6xl mx-auto p-4"> */}
      <div class="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div class="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-[#5084ff]" viewBox="0 0 512 512">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-xl font-bold">Visit office</h4>
              <p class="text-gray-800 text-lg font"> 5500 Stewart Avenue, Suite 108,
                Fremont, CA 94538</p>
            </div>
          </div>

          <a href='tel:+1-800-790-4550' className='no-underline flex flex-col items-center bg-white hover:bg-gray-100 hover:rounded-lg hover:shadow-lg'>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-[#5084ff]" viewBox="0 0 473.806 473.806">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-xl font-bold">Call us</h4>
              <p class="text-gray-800 text-lg font "> +1-800-790-4550</p>
            </div>
          </a>


          <a href='mailto:support@mycarelabs.com' className='no-underline flex flex-col items-center bg-white hover:bg-gray-100 hover:rounded-lg hover:shadow-lg'>

            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-[#5084ff]" viewBox="0 0 32 32">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-xl font-bold">Chat to us</h4>
              <p class="text-gray-800 text-lg font ">support@mycarelabs.com</p>
            </div>
          </a>


          <div class="flex flex-col items-center bg-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-[#5084ff]" viewBox="0 0 100 100">
            ...
            <div class="mt-4 text-center">
              <h4 class="text-gray-800 text-xl font-bold">Fax</h4>
              <p class="text-gray-800 text-lg font">+1-888-289-9940</p>
            </div>
          </div>

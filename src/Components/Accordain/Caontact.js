...
const Caontact = () => {
  ...
  <div class="bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-8">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div class="flex flex-col items-center bg-white">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-blue-600" viewBox="0 0 473.806 473.806">
      ...
      <div class="flex flex-col items-center bg-white">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-blue-600" viewBox="0 0 32 32">
      ...
      <div class="flex flex-col items-center bg-white">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 fill-blue-600" viewBox="0 0 100 100">

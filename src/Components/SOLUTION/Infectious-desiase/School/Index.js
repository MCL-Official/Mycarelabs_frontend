            ...
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    <h1 className="text-4xl text-gray-800 font-extrabold mx-auto md:text-5xl">
                        <div style={{ color: '#7597E6' }}>
                            Easy <span style={{ color: '#FF7244' }}>COVID-19/RSV/Flu</span> Testing For Schools
                        </div>
                    </h1>
                    <p className="text-lg max-w-xl mx-auto xl:mx-0">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-x-3 gap-y-3">
                        <Link
                            ...
                            className="flex items-center justify-center gap-x-2 py-2 px-4 text-white font-medium duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-lg"
                        ...
                        <Link
                            ...
                            style={{ backgroundColor: '#7597E6', color: 'white' }}
                        >
                            Book Test
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                                <path fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clipRule="evenodd" />

    ...
    const features = [
        {
            ...
            desc: "Rapid same-day results: MyCare Labs, your trusted healthcare partner."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            title: "No Appointments Needed, Walk-Ins Welcome!",
            desc: "Walk-in tests: Swift results at MyCare Labs for your convenience."
        },
        {
            icon:
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            desc: "We adhere to HIPAA standards and guarantee the confidentiality of all information."
        },
        // {
        //     icon:
        //         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
